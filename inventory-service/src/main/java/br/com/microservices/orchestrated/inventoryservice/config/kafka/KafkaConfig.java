...
public class KafkaConfig {
    ...
    public NewTopic notifyEndingTopic() {
        TopicSingleton.setNotifyEndingTopic(notifyEndingTopic);
        return buildTopic(notifyEndingTopic);
    }

    @Bean
    public NewTopic paymentFailTopic() {
        TopicSingleton.setPaymentFailTopic(paymentFailTopic);
    ...
    public NewTopic inventoryFailTopic() {
        TopicSingleton.setInventoryFailTopic(inventoryFailTopic);
